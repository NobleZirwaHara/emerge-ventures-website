...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0">Add New Training Program</h1>
    ...
    <div class="card shadow">
        <div class="card-body">
            <form action="{{ route('admin.digital-skills.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="card-body text-center">
                                <div class="mb-3">
                                    <div class="image-preview mb-3" style="max-width: 100%;">
                                        <img id="image-preview" src="{{ asset('assets/img/placeholder.jpg') }}"
